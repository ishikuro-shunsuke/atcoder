...
struct Clock {
  ...
  void shift(int diff_second) {
    int raw_second = hour * 60 * 60 + minute * 60 + second;

    raw_second += diff_second;

    if (raw_second < 0) {
      raw_second += 24 * 60 * 60;
    } else if (raw_second >= 24 * 60 * 60) {
      raw_second %= 24 * 60 * 60;
    }

    hour = raw_second / 60 / 60;
    minute = raw_second / 60 % 60;
    second = raw_second % 60;
  }
};
...
// STARTED: 2023/10/11 20:25:13
// SUBMITTED: 2023/10/14 20:23:56
